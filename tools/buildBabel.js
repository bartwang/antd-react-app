...
const buildContent = (content, filename, destination, babelOptions = {}) => {
  babelOptions.filename = filename;
  const result = transform(content, babelOptions);
  outputFileSync(destination, result.code, {encoding: 'utf8'});
};

const buildFile = (filename, destination, babelOptions = {}) => {
...
const buildBabel = (folderPath, destination, babelOptions = {}, firstFolder = true) => {
