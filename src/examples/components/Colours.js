    ...
    <div className="row">
      <div className="col-xs-12">
        ...
        <div className="bs-example">
          <div className="row">
            <div className="col-xs-3 text-center">
              <Badge size={54} customClass="white bg--white" />
              <p className="small margin-top-10">White</p>
              <p className="small">#FFFFFF</p>
            </div>
            <div className="col-xs-3 text-center">
              <Badge size={54} customClass="white bg--black" />
    ...
    <div className="row">
      <div className="col-xs-12">
        ...
        <div className="bs-example">
          <div className="row">
            <div className="col-xs-3 text-center">
              <Badge size={54} customClass="white bg--green" />
              <p className="small margin-top-10">Green</p>
              <p className="small">#2BAF6F</p>
            </div>
            <div className="col-xs-3 text-center">
              <Badge size={54} customClass="white bg--light-green" />
